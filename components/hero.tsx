...
const Hero = () => {
  return (
    <section id="about" className="flex flex-col lg:flex-row items-center justify-between bg-gradient-to-br from-yellow-200 to-orange-200 p-6 lg:p-10 rounded-3xl border-2 border-gray-800 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] max-w-full">
      <motion.div 
      ...
      >
        <h1 className="text-4xl lg:text-6xl font-bold text-gray-800">Naman Sharma</h1>
        <h2 className="text-2xl lg:text-4xl font-semibold text-blue-600">Software Engineer</h2>
