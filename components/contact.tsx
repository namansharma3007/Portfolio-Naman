...
const Contact = () => {
  return (
    ...
    >
      <h2 className="text-4xl lg:text-5xl font-bold text-center text-gray-800 mb-12">Let's Connect!</h2>
      <form className="space-y-6 max-w-2xl mx-auto">
        ...
        <Textarea 
          ...
          rows={6}
        />
        <Button className="w-full bg-red-400 hover:bg-red-500 text-white text-xl lg:text-2xl font-bold py-4 rounded-lg transform transition-all duration-300 hover:translate-x-1 hover:translate-y-1 border-2 border-gray-800 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] hover:shadow-none">
          <Send className="mr-2" />
          Send Message
        </Button>
      </form>
      <div className="mt-12 text-center">
        <p className="text-xl lg:text-2xl font-bold mb-4">Or reach out directly:</p>
        <p className="text-lg lg:text-xl">email@example.com | (123) 456-7890</p>
        <div className="mt-6 space-x-4">
          ...
          <Button className="bg-sky-400 hover:bg-sky-500 text-white transform transition-all duration-300 hover:translate-x-1 hover:translate-y-1 border-2 border-gray-800 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)] hover:shadow-none">
